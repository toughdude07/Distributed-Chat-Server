...
public class Method {
    ...
    // Display the user and it's attributes in list of users 
    ...
    // Duration at which the user joined the chat
    ...
    // Conversion to two digit string
    ...
    // Conversion to one digit string
