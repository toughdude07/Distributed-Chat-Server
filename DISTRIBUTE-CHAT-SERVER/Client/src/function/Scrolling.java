...
// Component which handles resize of Window to scale all components

// helps getting the co-ordinates of the mouse being clicked 
// and accordingly get the required information
