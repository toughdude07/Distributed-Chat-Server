...
public class Main extends javax.swing.JFrame {
    ...
    // Thread for starting the conversation
    private void start() {
    ...
    // adding a new user and refreshing the UI
    ...
    // current actions performed by user(it's status)
